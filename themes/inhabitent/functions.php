...
function inhabitent_scripts() {
	...
	wp_enqueue_script( 'font-awesome', 'https://use.fontawesome.com/2461701dd8.js', array(), '4.7.0', false );
	...
	wp_enqueue_script( 'inhabitent-search-bar', get_template_directory_uri() . '/build/js/search-bar.min.js', array( 'jquery' ), '1', true );
